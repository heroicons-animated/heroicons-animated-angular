...
@Component({
  selector: 'hi-hand-thumb-down',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'hand-thumb-down'",
    role: 'img',
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.handthumbdown-animate]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.handthumbdown-animate {
        animation: handthumbdown-wiggle 0.6s ease-in-out;
      }

      @keyframes handthumbdown-wiggle {
        0% {

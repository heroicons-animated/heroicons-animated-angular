...
@Component({
  selector: "hi-envelope-open",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'envelope-open'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.envelopeopen-animate]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.envelopeopen-animate {
        animation: envelopeopen-animate 0.4s ease-out forwards;
      }

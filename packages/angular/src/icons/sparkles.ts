...
@Component({
  selector: 'hi-sparkles',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'sparkles'",
    role: 'img',
  ...
  >
    <path
      ...
      class="sparkle-path sparkle-0"
      [class.sparkles-animate]="shouldAnimate()"
    />
    <path

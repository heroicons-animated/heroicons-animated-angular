...
@Component({
  selector: 'hi-hand-raised',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'hand-raised'",
    role: 'img',
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.handraised-animate]="shouldAnimate()"
  ...
  styles: [
    `
      ...
      .icon-svg.handraised-animate {
        animation: handraised-wiggle 0.8s ease-in-out;
      }

      @keyframes handraised-wiggle {
        0% {

...
@Component({
  selector: 'hi-arrow-long-up',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'arrow-long-up'",
    role: 'img',
  ...
  template: `<svg
    ...
    class="icon-svg"
  >
    <path class="head-path" [class.animate]="shouldAnimate()" d="M8.25 6.75 12 3m0 0 3.75 3.75" />
    <path #linePath d="M12 3v18" />
  </svg>`,
  styles: [
    `
      :host {
...
export class ArrowLongUpIcon {
  ...
  private readonly LINE_PATH_KEYFRAMES = ['M12 3v18', 'M12 6v15', 'M12 3v18'] as const;

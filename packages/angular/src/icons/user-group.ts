...
@Component({
  selector: 'hi-user-group',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'user-group'",
    role: 'img',
  ...
  >
    ...
    <path
      ...
      [class.usergroup-slide]="shouldAnimate()"
  ...
  styles: [
    `
      ...
      .usergroup-right.usergroup-slide {
        animation: usergroup-right-slide 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s forwards;
      }
      ...
      .usergroup-left.usergroup-slide {
        animation: usergroup-left-slide 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s forwards;
      }

...
@Component({
  selector: "hi-document",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'document'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.document-bounce]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.document-bounce {
        animation: document-bounce 0.3s ease-out;
      }

      @keyframes document-bounce {
        0%,
        100% {

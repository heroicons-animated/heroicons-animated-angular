...
@Component({
  selector: "hi-document-minus",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'document-minus'",
    role: "img",
  ...
  >
    ...
    <path
      d="M9 14.25H15"
      pathLength="1"
      class="documentminus-line"
      [class.documentminus-draw]="shouldAnimate()"
    />
  </svg>`,
  styles: [
    `
      ...
      .documentminus-line.documentminus-draw {
        animation: documentminus-draw 0.3s ease-out forwards;
      }

      @keyframes documentminus-draw {
        0% {
          stroke-dashoffset: 1;
          opacity: 0;
        }

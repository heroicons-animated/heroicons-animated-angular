...
@Component({
  selector: "hi-rectangle-stack",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'rectangle-stack'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.rectanglestack-stretch]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.rectanglestack-stretch {
        animation: rectanglestack-stretch 0.4s ease-in-out forwards;
      }

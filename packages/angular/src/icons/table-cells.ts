...
@Component({
  selector: "hi-table-cells",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'table-cells'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.tablecells-animate]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.tablecells-animate {
        animation: tablecells-pulse 0.4s ease-in-out forwards;
      }

      @keyframes tablecells-pulse {
        0% {
          transform: scale(1);
          opacity: 1;
        }

...
@Component({
  selector: "hi-shopping-bag",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'shopping-bag'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.shoppingbag-wiggle]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.shoppingbag-wiggle {
        animation: shoppingbag-wiggle 0.5s ease-in-out forwards;
      }

      @keyframes shoppingbag-wiggle {
        0% {

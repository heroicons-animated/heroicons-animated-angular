...
@Component({
  selector: 'hi-arrow-long-right',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'arrow-long-right'",
    role: 'img',
  ...
  template: `<svg
    ...
    class="icon-svg"
  >
    <path class="head-path" [class.animate]="shouldAnimate()" d="M17.25 8.25 21 12m0 0-3.75 3.75" />
...
export class ArrowLongRightIcon {
  ...
  private readonly LINE_PATH_KEYFRAMES = ['M21 12H3', 'M18 12H3', 'M21 12H3'] as const;

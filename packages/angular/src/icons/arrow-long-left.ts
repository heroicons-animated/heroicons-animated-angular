...
@Component({
  selector: 'hi-arrow-long-left',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '[attr.aria-label]': "'arrow-long-left'",
    role: 'img',
  ...
  template: `<svg
    ...
    class="icon-svg"
  >
    <path class="head-path" [class.animate]="shouldAnimate()" d="M6.75 15.75 3 12m0 0 3.75-3.75" />
    <path #linePath d="M3 12h18" />
  </svg>`,
  styles: [
    `
      :host {
...
export class ArrowLongLeftIcon {
  ...
  private readonly LINE_PATH_KEYFRAMES = ['M3 12h18', 'M6 12h15', 'M3 12h18'] as const;

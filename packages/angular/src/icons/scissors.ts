...
@Component({
  selector: "hi-scissors",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'scissors'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.scissors-squeeze]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.scissors-squeeze {
        animation: scissors-squeeze 0.25s ease-in-out forwards;
      }

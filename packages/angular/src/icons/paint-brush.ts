...
@Component({
  selector: "hi-paint-brush",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    "[attr.aria-label]": "'paint-brush'",
    role: "img",
  ...
  template: `<svg
    ...
    class="icon-svg"
    [class.paintbrush-animate]="shouldAnimate()"
  >
    <path
  ...
  styles: [
    `
      ...
      .icon-svg.paintbrush-animate {
        animation: paintbrush-animate 0.6s ease-in-out forwards;
      }

      @keyframes paintbrush-animate {
        0% {

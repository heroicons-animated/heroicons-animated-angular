...
export const HEROICONS_ANIMATED_CONFIG = new InjectionToken<HeroiconsAnimatedOptions>(
...
export function provideHeroiconsAnimated(options: HeroiconsAnimatedOptions): Provider[] {

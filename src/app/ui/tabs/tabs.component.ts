        ...
        @if (showArrow()) {
          @if (horizontal) {
            <button
              type="button"
              [class]="
                'scroll-btn scroll-left cursor-pointer pr-4 ' +
            ...
            <button
              type="button"
              [class]="
                'scroll-btn scroll-up cursor-pointer pb-4 ' +
        ...
        @if (showArrow()) {
          @if (horizontal) {
            <button
              type="button"
              [class]="
                'scroll-btn scroll-right cursor-pointer pl-4 ' +
                (zTabsPosition() === 'top' ? 'mb-4' : 'mt-4')
              "
            ...
            <button
              type="button"
              [class]="
                'scroll-btn scroll-down cursor-pointer pt-4 ' +
                (zTabsPosition() === 'left' ? 'mr-4' : 'ml-4')
              "
